...
# YOUR CODE HERE!
sum_of_loans = sum (loan_costs)
print (f"The total sum of all loans is $",sum_of_loans)
...
# YOUR CODE HERE!
average_loan_price = sum_of_loans / number_of_loans
print (f"The average price of a loan is $",average_loan_price)
...
if fair_value >=  loan["loan_price"]:
    ...
    print (f"The loan is too expensive and not worth buying")
...
present_value = present_value (
    future_value=1000, remaining_months=12, annual_discount_rate=0.2
)
print (f"The present value for this loan is ${present_value:.2f}")
